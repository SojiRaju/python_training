...
def user_profile_details(token, url):
    headers = {
        'Authorization': f'Bearer {access_token()}'
    }
    response = requests.get(url + "profile-details", headers=headers)
    if response.status_code == 200:
        data = response.json()
        print(data)
    else:
        print(f"Error: {response.status_code}")
user_profile_details(token=access_token(), url="https://dev-api.pttapp.com/api/")
...
def basic_info(token, url):
    ...
    cId = random.randint(1000, 9999)  # Replace the range with desired values
    payload ={
...
def step2(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
step2(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def step3(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
step3(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def anomalies_step4(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
anomalies_step4(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def banking_columns_step5(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
banking_columns_step5(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def claim_columns_step6(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
claim_columns_step6(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def client_details(token, url, client_id):
    ...
    if response.status_code == 200:
        ...
        print(f"Error: {response.status_code}")
client_details(token=access_token(), url="https://dev-api.pttapp.com/api/", client_id=basic_info(token=access_token(), url="https://dev-api.pttapp.com/api/"))
...
def trust_balance(token, url, client_id):
    ...
    response = requests.get(url + "reports/trust-balance?", params=payload, headers=headers)
    if response.status_code == 200:
        data = response.json()
        # Pretty-print the JSON response
        formatted_json = json.dumps(data, indent=4)
...
def trust_balance_export(token, url, client_id):
    ...
    response = requests.get(url + "reports/trust-balance/export?", params=payload, headers=headers)
...
def client_file_report(token, url, client_id):
    ...
    response = requests.get(url + "reports/client-files?", params=payload, headers=headers)
    if response.status_code == 200:
        data = response.json()
        # Pretty-print the JSON response
        formatted_json = json.dumps(data, indent=4)
...
def client_file_export(token, url, client_id):
    ...
    response = requests.get(url + "reports/client-files/export?", params=payload, headers=headers)
    if response.status_code == 200:
        print(f"Success: {response.status_code}")
